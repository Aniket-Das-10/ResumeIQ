  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 w-11/12 mx-auto text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8" style={{ animation: 'fadeIn 0.6s ease' }}>
          <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
          <span className="text-xs text-slate-300 font-medium">AI-Powered Resume Intelligence</span>
        </div>

        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight mb-6" style={{ animation: 'fadeIn 0.8s ease' }}>
        ...
        {/* Subheading */}
        <p className="max-w-2xl mx-auto text-lg sm:text-xl text-slate-400 leading-relaxed mb-10" style={{ animation: 'fadeIn 1s ease' }}>
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animation: 'fadeIn 1.2s ease' }}>
          <button
            onClick={() => console.log('Get Started clicked')}
            id="hero-get-started"
            className="group inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-semibold text-sm shadow-xl shadow-violet-500/25 hover:shadow-violet-500/40 hover:scale-105 active:scale-[0.98] transition-all duration-200 cursor-pointer"
          >
            Get Started
            <HiOutlineArrowRight className="group-hover:translate-x-1 transition-transform" size={16} />
          </button>
          <button
            onClick={() => console.log('Upload Resume clicked')}
            id="hero-upload-resume"
            className="group inline-flex items-center gap-2 px-8 py-3.5 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm text-slate-200 font-semibold text-sm hover:bg-white/10 hover:border-white/20 hover:scale-105 active:scale-[0.98] transition-all duration-200 cursor-pointer"
          >
        ...
        {/* Stats */}
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 sm:gap-12" style={{ animation: 'fadeIn 1.4s ease' }}>
          {[
