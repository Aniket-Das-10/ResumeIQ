        ...
        >
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            ...
            <p style={{ marginTop: '6px', fontSize: '14px', color: '#94a3b8' }}>
              Join ResumeIQ and land your dream job
            </p>
          </div>
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }} aria-hidden="true">
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(ellipse at top right, rgba(124,58,237,0.1), transparent 50%), radial-gradient(ellipse at bottom left, rgba(236,72,153,0.08), transparent 50%)',
          }}
        />
        {/* Blobs */}
        <div
